"""Short post-installation smoke verification for Stage 14.2."""
...
from .install_2022_release import ELECTION_2022, ELECTION_2025
...
def verify() -> dict:
    ...
    checks = {
        "election_catalogue": (election_ids, [ELECTION_2025, ELECTION_2022]),
        "2025_house_seats": (
            feeds.build(
