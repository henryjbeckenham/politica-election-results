#!/usr/bin/env python3
"""Verify a clean Stage 3 -> 14.2 -> 14.3 upgrade in isolation."""
...
def overlay_application(project: Path) -> None:
    """Install the Stage 14.3 application payload without touching project data."""
...
def verify(
    ...
    with tempfile.TemporaryDirectory(prefix="politica-stage14-3-integration-") as temporary:
        root = Path(temporary)
        ...
        expected_elections = [ELECTION_2025, ELECTION_2022, ELECTION_2019]
        ...
        expected_boundaries = {ELECTION_2025: 150, ELECTION_2022: 151, ELECTION_2019: 151}
        ...
        return {
            ...
            "active_release_id": stage14_3["release_id"],
            "active_database_sha256": stage14_3["database_sha256"],
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=PROJECT_ROOT / "dist" / "stage_14_3_integration_report.json",
    )
    args = parser.parse_args()
    report = verify(args.base_zip, args.stage14_2_core, list(args.stage14_2_data))
