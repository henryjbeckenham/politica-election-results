#!/usr/bin/env python3
"""Verify a clean Stage 3 -> 14.2 -> 14.3 -> 14.4 -> 14.5 upgrade."""
...
def overlay_application(project: Path) -> None:
    """Install the Stage 14.5 application payload without touching project data."""
...
def verify(
    ...
    workspace = (
        ...
        else tempfile.TemporaryDirectory(prefix="politica-stage14-5-integration-")
    )
    with workspace as temporary:
        ...
        return {
            ...
            "active_release_id": stage14_5["release_id"],
            "active_database_sha256": stage14_5["database_sha256"],
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=PROJECT_ROOT / "dist" / "stage_14_5_integration_report.json",
    )
